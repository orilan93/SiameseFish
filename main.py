from classification import \
    CNNClassifier, EmbeddingSVCClassifier, EmbeddingMLPClassifier, \
    EmbeddingKNNClassifier, EmbeddingDistanceClassifier
...
# Må shuffles eller så er alle klassene i test ikke representert i trening
...
# VIKTIG: Ikke lagre trenings embeddings og så trene på nytt fordi da havner mye av test settet i treningsdataen!
